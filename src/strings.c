...
const u8 gText_IVResults[] = _("{STR_VAR_2} - {STR_VAR_1}/186 ({STR_VAR_3}){PAUSE_UNTIL_PRESS}");
const u8 gText_IVResults_Perfect[] = _("PERFECT SPECIMEN OF A {STR_VAR_2}!{PAUSE_UNTIL_PRESS}");
const u8 gText_IVResults_Lousy[] = _("LOUSY EXCUSE FOR A {STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
const u8 gText_IV_HighestHP[] = _("HP");
const u8 gText_IV_HighestAttack[] = _("ATTACK");
const u8 gText_IV_HighestDefense[] = _("DEFENSE");
const u8 gText_IV_HighestSpeed[] = _("SPEED");
const u8 gText_IV_HighestSpAttack[] = _("SP. ATK");
const u8 gText_IV_HighestSpDefense[] = _("SP. DEF");
