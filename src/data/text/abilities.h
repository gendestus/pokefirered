...
static const u8 sAftermathDescription[] = _("Damages the attacker landing the final hit.");
static const u8 sAngerPointDescription[] = _("Maximizes Attack upon taking a critical hit.");
static const u8 sAnticipationDescription[] = _("Senses the foe's dangerous moves.");
static const u8 sBadDreamsDescription[] = _("Damages sleeping foes.");
static const u8 sDownloadDescription[] = _("Adjusts power according to the foe's stats.");
static const u8 sDrySkinDescription[] = _("Absorbs Water moves, heals in rain, but is hurt by sunlight.");
static const u8 sFilterDescription[] = _("Reduces damage from super-effective attacks.");
static const u8 sFlowerGiftDescription[] = _("Powers up party Pokémon when it's sunny.");
static const u8 sForewarnDescription[] = _("Determines what moves an opposing Pokémon has.");
static const u8 sFriskDescription[] = _("Reveals the foe's held item.");
static const u8 sGluttonyDescription[] = _("Uses a held Berry earlier than usual.");
static const u8 sHeatproofDescription[] = _("Halves damage from Fire moves.");
static const u8 sHoneyGatherDescription[] = _("May gather Honey after battle.");
static const u8 sHydrationDescription[] = _("Heals status problems in rain.");
static const u8 sIceBodyDescription[] = _("Heals in hail.");
...
static const u8 sLeafGuardDescription[] = _("Prevents status problems in sunny weather.");
static const u8 sMagicGuardDescription[] = _("Only takes damage from attacks.");
static const u8 sMoldBreakerDescription[] = _("Moves can be used regardless of Abilities.");
static const u8 sMotorDriveDescription[] = _("Boosts the Speed stat when it's hit by an Electric-type move.");
static const u8 sMultitypeDescription[] = _("Changes the Pokémon's type to match the Plate it holds.");
static const u8 sNoGuardDescription[] = _("Ensures attacks by or against the Pokémon land.XYEnsures that attacks by or against the Pokémon will land.ORAS");
static const u8 sNormalizeDescription[] = _("All the Pokémon's moves become Normal type.");
static const u8 sPoisonHealDescription[] = _("Restores HP if the Pokémon is poisoned.");
static const u8 sQuickFeetDescription[] = _("Boosts the Speed stat if the Pokémon has a status condition.");
static const u8 sRecklessDescription[] = _("Powers up moves that have recoil damage.");
static const u8 sRivalryDescription[] = _("Deals more damage to Pokémon of the same gender.");
static const u8 sScrappyDescription[] = _("Makes Normal- and Fighting-type moves hit Ghost-type Pokémon.");
static const u8 sSimpleDescription[] = _("The Pokémon is prone to wild stat changes.");
static const u8 sSkillLinkDescription[] = _("Increases the number of times multi-strike moves hit.");
static const u8 sSlowStartDescription[] = _("Temporarily halves the Pokémon's Attack and Speed stats.");
static const u8 sSniperDescription[] = _("Powers up moves if they become critical hits.");
static const u8 sSnowCloakDescription[] = _("Boosts evasion in a hailstorm.");
static const u8 sSnowWarningDescription[] = _("The Pokémon summons a hailstorm when it enters a battle.");
static const u8 sSolarPowerDescription[] = _("Boosts the Sp. Atk stat in sunny weather, but HP decreases.");
static const u8 sSolidRockDescription[] = _("Reduces damage from supereffective attacks.");
static const u8 sStallDescription[] = _("The Pokémon moves after all other Pokémon do.");
static const u8 sSteadfastDescription[] = _("Boosts the Speed stat each time the Pokémon flinches.");
static const u8 sStormDrainDescription[] = _("Draws in all Water-type moves to boost its Sp. Atk stat.");
static const u8 sSuperLuckDescription[] = _("Boosts the critical-hit ratios of moves.");
static const u8 sTangledFeetDescription[] = _("Raises evasion if the Pokémon is confused.");
...
static const u8 sUnawareDescription[] = _("Ignores the opposing Pokémon's stat changes.");
static const u8 sUnburdenDescription[] = _("Boosts the Speed stat if its held item is used or lost.");
