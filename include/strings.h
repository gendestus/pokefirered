...
extern const u8 gText_IVResults[];
extern const u8 gText_IVResults_Perfect[];
extern const u8 gText_IVResults_Lousy[];
extern const u8 gText_IV_HighestHP[];
extern const u8 gText_IV_HighestAttack[];
extern const u8 gText_IV_HighestDefense[];
extern const u8 gText_IV_HighestSpeed[];
extern const u8 gText_IV_HighestSpAttack[];
extern const u8 gText_IV_HighestSpDefense[];
